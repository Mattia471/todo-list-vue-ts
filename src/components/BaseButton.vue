...
onMounted(() => {
  switch (props.type.toUpperCase()) {
    case "SOLID":
      classValue.value = "px-3 py-2 text-sm  text-white bg-blue-700 shadow-sm hover:bg-indigo-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600";
      break;
    case "OUTLINE":
...
<template>
  <button type="button" :class="classValue.concat(' ' + parentClass)" @click="emitAction" :disabled="props.disabled">
